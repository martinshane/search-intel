"""
Module 4: Content Intelligence — thin content detection, keyword
cannibalization, striking distance opportunities, content gap analysis.

Phase 3 full implementation.  Consumes GSC query-page mapping, crawl data,
and GA4 engagement metrics to produce:
  1. Cannibalization cluster detection
  2. Striking distance opportunity identification
  3. Thin content flagging with engagement signals
  4. Content age vs performance quadrant matrix
"""
