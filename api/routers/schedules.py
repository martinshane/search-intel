...
def _get_supabase():
    """Get Supabase client with service-role privileges via centralized database module.

    Schedules need the service-role key to bypass RLS for cross-user
    operations (e.g. cron-triggered report generation).
    """
    try:
